...
| [`authoring.md`](authoring.md) — your first hook | How do I actually write one in Rust, register it, and confirm it fired? | You're ready to build. Its ten-minute walkthrough is **assembled from compile-guarded sources but not yet executed end to end** — board item `01KYTP8BT2BT4ADAPZENHT4FQV` tracks running it verbatim. |
