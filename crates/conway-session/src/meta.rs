...
//! `conway_session::{SessionMeta, ForkOrigin, SessionStatus, SessionFilter}`
//! is a stable, crate-root-reachable path (per `lib.rs`'s re-export list)
//! without every downstream module reaching into `conway_core::log`
//! directly.
//!
...
pub use conway_core::log::{ForkOrigin, SessionFilter, SessionMeta, SessionStatus};
